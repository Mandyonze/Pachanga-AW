...
<head>
  ...
  <link rel="stylesheet" href="css/aceptarJugador.css">
...
<header>
  ...
  <br><br>
        ...
        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
          <div class="jumbotron">
            <h3>ACEPTAR AL JUGADOR EN EL PARTIDO</h3>
            <br>
            <p>
              El jugador "Mourinho" quiere unirse al partido que has creado el día 15-04-2017 a las 15:30.
            </p>
            <button type="button" class="btn button-ver button-ver mouse-over boton" onclick="window.location.href='miPerfil.html'">Ver perfil</button>
            <div class="btn-group grupo">
              <button type="button" class="btn button-ver button-ver mouse-over boton" onclick="window.location.href='inicio.html'">Aceptar</button>
              <button type="button" class="btn button-ver button-ver mouse-over boton" onclick="window.location.href='inicio.html'">Rechazar</button>
            </div>
          </div>
        </div>
      </div>
