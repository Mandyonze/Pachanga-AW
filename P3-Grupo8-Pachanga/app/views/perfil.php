...
<div class="profile-container">
    <div class="profile">
      <img class="img-circle tam-perfil" src="img/iconos/huevo.png" alt="face">
       <h1 class="profile-name">Cristiano Ronaldo</h1>
       <br>
    </div>
  </div>
  ...
  <div class="row " >
      ...
      <div class="col-xs-5 col-md-3 cuadro_negro">Tetuán</div>
  </div>

  <div class="row " >
      <div class="col-xs-offset-1 col-xs-5 col-md-offset-3 col-md-3 cuadro_naranja">Email</div>
      <div class="col-xs-5 col-md-3 cuadro_negro">Cr7@ucm.es</div>
  </div>
  ...
  <div class="row " >
      <div class="col-xs-offset-1 col-xs-5 col-md-offset-3 col-md-3 cuadro_naranja sin_pading">Valoracion Media</div>
      <div class="col-xs-5 col-md-3 cuadro_negro">
      ...
      <div  id = "compartir" class="container backgroundFormulario">
        <div class="formulario formulario-container animateFormulario">
          ...
          <div class="body-formulario">
           ...
           <div class = "centrar"><h3>Compartir</h3></div>
